...
FIELDS: tuple[ConfigFieldSpec, ...] = (
    ...
    ConfigFieldSpec(
        ...
        "providers",
        "secret",
        settings_attr="localmaxxing_api_key",
        secret=True,
        description="API key for your LocalMaxxing OpenAI-compatible endpoint.",
    ),
    ConfigFieldSpec(
        "LOCALMAXXING_BASE_URL",
        "LocalMaxxing Base URL",
        "providers",
        settings_attr="localmaxxing_base_url",
        description="Base URL for your LocalMaxxing endpoint (e.g., http://localhost:8080/v1).",
    ),
    ConfigFieldSpec(
        "LM_STUDIO_BASE_URL",
        "LM Studio Base URL",
    ...
    ConfigFieldSpec(
        ...
        "providers",
        "secret",
        settings_attr="localmaxxing_proxy",
        secret=True,
        advanced=True,
    ),
    ConfigFieldSpec(
